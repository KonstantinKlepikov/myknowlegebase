...
- Built-in functions объекты встроенных функций интерпретатора (обертка на c-реализациями).
...
11. I/O objects - объекты ввода/вывода
...
- Frame objects. Представляют собой фреймы исполнения. Они могут встречаться в объектах трассировки , а также передаются зарегистрированным функциям трассировки
...
- Class method objects. Объект метода класса, как объект статического метода, представляет собой оболочку вокруг другого объекта, которая изменяет способ получения этого объекта из классов и экземпляров классов. Объекты метода класса создаются встроенным `classmethod()` конструктором.
...
- [__str__](https://docs.python.org/3/reference/datamodel.html#object.__str__) Человекочитаемое строкове представление. Будет вызван `__repr__()` по умолчанию
...
- [__hash__](https://docs.python.org/3/reference/datamodel.html#object.__hash__) Вызов встроенной функции `hash()`. Используется так-же для сранвнеия
- [__bool__](https://docs.python.org/3/reference/datamodel.html#object.__bool__). Реализует проверку истинности. Если этот метод не поределен, то вызывается `__len__()`. Если `__len__()` не определен, то все элементы класса считаются истинными.
...
Дополнительный список методов [смотри тут](https://docs.python.org/3/reference/datamodel.html#emulating-container-types)
...
- [__aiter__](https://docs.python.org/3/reference/datamodel.html#object.__aiter__) возвращает объект асинхронного итератора
- [__anext__](https://docs.python.org/3/reference/datamodel.html#object.__anext__) возвращает awaitable значение. Должен вызывать `StopAsyncIteration` исключение по окончании итерации.
...
- [__aenter__](https://docs.python.org/3/reference/datamodel.html#object.__aenter__) должен возвращать ожидаемый объект
- [__aexit__](https://docs.python.org/3/reference/datamodel.html#object.__aexit__) аналогично
