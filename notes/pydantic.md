...
- [attrs](https://www.attrs.org/en/stable/) is the Python package that will bring back the joy of writing classes by relieving you from the drudgery of implementing object protocols (aka dunder methods)
...
- [Using bson.ObjectId in Pydantic v2](https://stackoverflow.com/questions/76686888/using-bson-objectid-in-pydantic-v2)
- [Remove an inherited field from a model in pydantic v2](https://github.com/pydantic/pydantic/discussions/6699), [Remove inherited/parent field from model](https://github.com/pydantic/pydantic/discussions/2686)
