...
Клиент написан поверх [[asyncio]]. Базовые функции сходны с асинхронным АПИ [[httpx]], с тем лишь исключением, что сразу реализован собственный session класс и вся работа ведется с ним.
...
### [Handlers](https://docs.aiohttp.org/en/stable/web_quickstart.html#handler)
...
[[pytest]] [pytest-aiohttp](https://github.com/aio-libs/pytest-aiohttp) **The library provides useful fixtures for creation test aiohttp server and client**
...
- [aiohttp: set maximum number of requests per second](https://stackoverflow.com/questions/35196974/aiohttp-set-maximum-number-of-requests-per-second)
