...
Общая конфигурация для запросов (внемательно изучи поведение при мерже глобального конфига и внутри контекста - для разных полей запроса поведение отличается):
