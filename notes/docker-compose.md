...
- [Share Compose configurations between files and projects](https://docs.docker.com/compose/extends/#multiple-compose-files). [Mark services to be only started in specific profiles](https://stackoverflow.com/a/65922688/15966204)
