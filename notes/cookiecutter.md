...
clone project template and change it in `cookiecutter.json`

`git clone git@github.com:audreyr/cookiecutter-pypackage.git` ([ссылка](https://github.com/audreyfeldroy/cookiecutter-pypackage))

generate from template ([опции командной строки тут](https://cookiecutter.readthedocs.io/en/stable/cli_options.html)):

`cookiecutter cookiecutter-pypackage/`

Источниками шаблонов могут быть открытые и приватные репозитории, а так-же зазипованыне файлы.

### Примеры

- [Tutorials](https://cookiecutter.readthedocs.io/en/stable/tutorials/index.html)
